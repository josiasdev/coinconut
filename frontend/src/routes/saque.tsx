...
function Saque() {
  ...
  const [amount, setAmount] = useState(SALDO.toFixed(2));
  const [stage, setStage] = useState<Stage>("idle");

  const amountNum = parseFloat(amount) || 0;
  const isValid = pixKey.length > 3 && amountNum > 0 && amountNum <= SALDO;
              ...
              <div className="glass-card rounded-2xl p-7 relative overflow-hidden">
                ...
                <div className="relative">
                  ...
                  <div className="text-xs text-muted-foreground mt-3">
                    Referente a 142 kg de casca certificada
                  </div>
                </div>
              </div>
              ...
              <form onSubmit={submit} className="space-y-5">
                ...
                <div className="glass-card rounded-2xl p-7">
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <button
                      type="button"
                      onClick={() => setAmount(SALDO.toFixed(2))}
